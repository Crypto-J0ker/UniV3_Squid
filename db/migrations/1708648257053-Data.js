module.exports = class Data1708648257053 {
    name = 'Data1708648257053'

    async up(db) {
        await db.query(`CREATE TABLE "swap" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "hash" text NOT NULL, "amount0" numeric NOT NULL, "amount1" numeric NOT NULL, "sender" text NOT NULL, "recipient" text NOT NULL, "pool_id" character varying, CONSTRAINT "PK_4a10d0f359339acef77e7f986d9" PRIMARY KEY ("id"))`)
